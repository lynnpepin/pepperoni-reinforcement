...
rld, raccb, ri, r, LD, AccB, ci, AD, circles, faces, cb, anchor_x, anchor_y, origin = _generate_circlepacking(tri, 
                                     delta, eps, delta_r)
...
_modify_circlepacking(rld_new, raccb, ri, r, LD, AccB, ci, AD, circles, eps, delta_r)
    

    
edges = _generate_boundary_edges(LD, circles, faces, anchor_x, anchor_y, origin)
_draw_circles(circles,l)
